...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DAATBASE_NAME = "wguCompanion";
    ...
    public static final String TABLE_STATUS_TYPE = "statusType";
    ...
    public static final String STATUS_S_TYPE_ID = "status_type_id";
    public static final String STATUS_NAME = "status_name";

    //Type Columns
    public static final String STATUS_TYPE_ID = "_id";
    public static final String STATUS_TYPE_NAME = "type_name";

    //SQL Column Arrays for all Tables
    public static final String[] PROGRAM_COLUMNS = {PROGRAM_ID, PROGRAM_NAME, PROGRAM_DEGREE_TYPE};
    public static final String[] TERM_COLUMNS = {TERM_ID, TERM_NAME, TERM_PROGRAM_ID, TERM_START_DATE, TERM_END_DATE,
                                                 TERM_START_REMINDER, TERM_END_REMINDER, TERM_STATUS};
    ...
    public static final String[] STATUS_COLUMNS = {STATUS_ID, STATUS_S_TYPE_ID, STATUS_NAME};
    public static final String[] STATUS_TYPE_COLUMNS = {STATUS_TYPE_ID, STATUS_TYPE_NAME};
    ...
    private static final String TERM_TABLE_CREATE =
            "CREATE TABLE " + TABLE_TERM + "(" + TERM_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    TERM_NAME + " TEXT, " + TERM_PROGRAM_ID + " INTEGER, " + TERM_START_DATE + " TEXT, " + TERM_END_DATE +
                    " TEXT, " + TERM_START_REMINDER + " INTEGER, " + TERM_END_REMINDER + " INTEGER, " + TERM_STATUS + " TEXT, " +
    ...
    private static final String ASSESSMENT_TYPE_TABLE_CREATE =
            "CREATE TABLE " + ASSESSMENT_TYPE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + ASSESSMENT_TYPE_NAME + " TEXT" + ");";
    //MENTOR TABLE
    ...
    private static final String STATUS_TABLE_CREATE =
            "CREATE TABLE " + TABLE_STATUS + "(" + STATUS_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    STATUS_S_TYPE_ID + " INTEGER, " + STATUS_NAME + " TEXT, " +
                    " FOREIGN KEY (" + STATUS_S_TYPE_ID + ") REFERENCES " + TABLE_STATUS_TYPE + "(" + STATUS_TYPE_ID + ")" + ");";
    private static final String STATUS_TYPE_TABLE_CREATE =
            "CREATE TABLE " + TABLE_STATUS_TYPE + "(" + STATUS_TYPE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    STATUS_TYPE_NAME + " INTEGER, " + ");";

    public DBHelper(Context context) {
        super(context, DAATBASE_NAME, null, DATABASE_VERSION);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(STATUS_TYPE_TABLE_CREATE);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_STATUS_TYPE);
        onCreate(db);
    }
}
